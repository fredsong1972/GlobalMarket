...
import { BarStyles, CONTAINER_ID, IntervalTypes, ITradingViewWidget, SCRIPT_ID, Themes } from './angular-tradingview-widget.model';
...
export class AngularTradingviewWidgetComponent implements OnInit {
  ...
  private _widgetConfig: ITradingViewWidget = this._defaultConfig;
  style: {} = {};
